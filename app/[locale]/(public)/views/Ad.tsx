                ...
                <div className="flex items-center justify-between px-3 py-2">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <span className="text-sm text-white/90 group-hover:text-primary transition-colors duration-300 font-medium">
                        {selectedMaterial?.title}
                      </span>
                      <svg 
                        className="w-4 h-4 text-white/70 group-hover:text-primary transform translate-x-0 group-hover:translate-x-1 transition-all duration-300" 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24" 
