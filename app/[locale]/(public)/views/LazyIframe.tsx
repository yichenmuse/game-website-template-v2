      ...
      <div className={containerClassName + " flex flex-col items-center justify-center p-4 md:p-8"}>
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto">
          <div className="flex flex-col items-center gap-8">
            {/* 游戏图片 */}
            <div 
              className="relative group w-full max-w-[480px] cursor-pointer"
              onClick={() => {
                if (type === 'download') {
            ...
            >
              <div className="w-full aspect-video rounded-2xl overflow-hidden border-4 border-yellow-500/50">
                {gameImage ? (
                  <Image 
                    src={gameImage} 
                    alt={title}
            ...
            <div className="text-center">
              <h1 className="text-3xl md:text-5xl font-bold text-yellow-400 mb-8 font-leckerli leading-tight">
                {title}
              </h1>
              ...
              <button
                ...
                className="group relative flex items-center gap-2 md:gap-3 bg-yellow-500 hover:bg-yellow-400 text-black px-8 md:px-10 py-4 md:py-5 rounded-full font-bold text-lg md:text-xl transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_40px_rgba(234,179,8,0.4)]"
              >
